...
import bwie.com.gouwuwu.bean.PriceAndCount;

/**
 * Created by BAIPEI on 2017/12/17.
 */
...
class ExAdapter extends BaseExpandableListAdapter{
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        holder.cbGroup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //3.全选的checkbox状态值
                ((Main3Activity) context).setCheckAll(setCheckAll());
                //计算钱和数量并显示
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        holder.btDel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                setPriceAndCount();
                //改变全选状态
                ((Main3Activity) context).setCheckAll(isAllGroupCbChecked());
                //刷新列表
                notifyDataSetChanged();
            }
        });
    ...
    public void setPriceAndCountText(){
        ((Main3Activity)context).PriceAndCount(setPriceAndCount());
    }
    ...
    /*private void setPriceAndCount() {
        ((Main3Activity)context).setPriceAndCount(compute());
    }*/
